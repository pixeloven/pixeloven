...
-   Onboarding
    -   Finish getting started documentation
...
-   Workflow
    -   Create improved Docker based workflow for integration
...
-   Custom Publisher
    -   PR Lerna and/or provide as a standalone
    -   https://github.com/pixeloven/book
        -   While coverting to TS we fell below 100% coverage need to make sure this is acceptable and not breaking
-   Express server
