...
Prettier supports multiple languages out of the gate. As a result unlike [CLI: PixelOven.Lint](/docs/api/cli-core-lint) this CLI has no need for arguments to be passed to handle for different languages.
