# PixelOven TypeScript Framework
...
A small framework written in TypeScript to facilitate development for isomorphic React applications.

### Contributing
**Start coding!** When creating new packages please follow the pattern defined by previous `package.json` and entry files. Please review our [contribution guide](./CONTRIBUTING.md) for more details about contributing to this project.
...
Simply search for `@pixeloven` at [npm](https://www.npmjs.com/) and install the desired packages.

Then you project simply import the install package and away you go!
```javascript
import {sleep} from '@pixeloven/core'
```

Additionally, you can import the transpiled modules from `dist/lib` in case you have a modular library:

```javascript
import {sleep} from '@pixeloven/dist/lib/macros'
```
...
lerna bootstrap
```
https://github.com/Quramy/lerna-yarn-workspaces-example/blob/master/README.md
